    ...
    return (
      <div className="App">
        ...
        <div className="App__title">
          ...
          <p id="App-added-text">This page is for brainstorming. You can add extra ideas and claim ideas to tackle. To officially submit to the Ignite Your Vision challenge, <a href="https://helloignite.io/static/app/index.html#/event/masonCounty2018/static/Overview" target="_blank">please visit the official entry page.</a></p>
        </div>
